    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (preg_match('#^/blog(?:/(?P<page>\\d*))?$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Sdz\\BlogBundle\\Controller\\BlogController::indexAction',  'page' => '1',)), array('_route' => 'sdzblog_accueil'));
            }
